...
MKELF := device/sony/huashan/custombootimg/mkelf.py
INITSH := device/sony/huashan/custombootimg/init.sh
BOOTREC_DEVICE := $(PRODUCT_OUT)/recovery/bootrec-device
CWM_RECOVERY := device/sony/huashan/custombootimg/ramdisk-recovery.cpio
CWM_BUSYBOX := device/sony/huashan/custombootimg/busybox
